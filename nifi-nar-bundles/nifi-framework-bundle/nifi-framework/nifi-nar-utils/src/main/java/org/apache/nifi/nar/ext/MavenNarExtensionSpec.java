 ...
 */
public class MavenNarExtensionSpec extends NarExtensionSpec {
     ...
     */
    public MavenNarExtensionSpec(String groupId, String artifactId, String version) {
        super();
     ...
     */
    public MavenNarExtensionSpec(String groupId, String artifactId, String version, String packaging) {
     ...
     */
    public MavenNarExtensionSpec(String groupId, String artifactId, String version, String packaging, URI resourceURI) {
        super();
        this.groupId = groupId;
        this.artifactId = artifactId;
        this.version = version;
    ...
    public URI resolve() {
        if (resourceURI == null) {
            // We don't have a physical copy of artifact yet
            final String gav = groupId + ":" + artifactId + ":" + packaging + ":" + version;
            resourceURI = Maven.resolver().resolve(gav).withoutTransitivity().asSingleFile().toURI();
        }
        return resourceURI;
